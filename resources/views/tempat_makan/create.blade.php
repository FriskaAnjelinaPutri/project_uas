...
<div class="container">
    ...
    {{-- Form pakai enctype multipart untuk upload file --}}
    <form action="{{ route('tempat-makan.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3">
            <label for="gambar" class="form-label">Foto Tempat Makan</label>
